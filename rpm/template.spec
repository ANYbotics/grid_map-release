Name:           ros-kinetic-grid-map-demos
Version:        1.6.0
Release:        0%{?dist}
...
Requires:       ros-kinetic-grid-map-cv
Requires:       ros-kinetic-grid-map-filters
Requires:       ros-kinetic-grid-map-loader
Requires:       ros-kinetic-grid-map-msgs
Requires:       ros-kinetic-grid-map-octomap
Requires:       ros-kinetic-grid-map-ros
Requires:       ros-kinetic-grid-map-rviz-plugin
...
BuildRequires:  ros-kinetic-grid-map-cv
BuildRequires:  ros-kinetic-grid-map-filters
BuildRequires:  ros-kinetic-grid-map-loader
BuildRequires:  ros-kinetic-grid-map-msgs
BuildRequires:  ros-kinetic-grid-map-octomap
BuildRequires:  ros-kinetic-grid-map-ros
BuildRequires:  ros-kinetic-grid-map-rviz-plugin
